  ...
  return (
    <div>
      ...
      <button type="submit">Submit</button> */}
        ...
        <div className="">
        <button className="py-2 text-center bg-[#30a525] w-[100%] mt-6 rounded" type="submit">Submit</button>
        </div>
        </div>
      </form>
      <Link className="py-3 inline-block underline" href='/'> All users</Link>
    </div>
  );
}
